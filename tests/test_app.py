...
def mock_connection_manager():
    with patch('ConnectionManager.ConnectionManager') as MockConnectionManager:
        mock_connection = MagicMock()
        MockConnectionManager.return_value = mock_connection
        yield mock_connection

def test_command_execution(mock_connection_manager):
    ...
    app.connections.append(mock_connection_manager)
